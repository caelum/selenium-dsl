...
public class WebDriverPlainTableLayout implements TableLayout {

	private final WebDriverTableLayoutHelper helper;

	public WebDriverPlainTableLayout(final WebDriver webDriver, final String id, final String type) {
	...
	public String headerLinkValue(final int col) {
		return helper.getTableElementByXPathText("/*/tr[1]/td[" + col + "]/a").getText();
	}
